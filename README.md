...
![MeasureActivtyUI](./assets/MeasureActivtyUI.JPG)

![Activity Toolbar](./assets/Activity_Toolbar.png)
...
<p align="center"><img src="./assets/time_freq_switch_demo.gif" width="300" height="300" /></p>

* **Zoom:** User can increase or decrease scale of x-axis with the help of zoom button and sliders.
<p align="center"><img src="./assets/zoom_settings_demo.gif" width="300" height="300" /></p>

* **Play and Pause:** User can play or pause plotting of graph.
* **Waveform setting:**
    * **Amplitude:** User can increase or decrease amplitude of waveform.
    <p align="center"><img src="./assets/amplitude_demo.gif" height="300" /></p>
    
    * **Inversion:** User can invert waveform.
    <p align="center"><img src="./assets/waveform_invert_demo.gif" height="300" width="300" /></p>
    ...
    * **Triggering Edge:** User can switch between None, rising and falling mode. Different mode represent different plotting of first waveform edge.
    <p align="center"><img src="./assets/triggering_edge_demo.gif" height="300" width="300" /></p>
...
<p align="center"><img src="./assets/select_note_demo.gif" height="250" width="400" /></p>
...
* **Tuning Palette:**
    * **Harmonics:** User can show or hide harmonics.
    <p align="center"><img src="./assets/show_harmonics_demo.gif" height="250" width="400" /></p>
    
    * **Tuning line:** User can show or hide tuning line.
    <p align="center"><img src="./assets/show_tuning_line_demo.gif" height="250" width="400" /></p>
